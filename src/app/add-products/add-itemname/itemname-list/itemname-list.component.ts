...
@Component({
  selector: 'app-itemname-list',
  templateUrl: './itemname-list.component.html',
  styleUrls: ['./itemname-list.component.scss']
})
export class ItemnameListComponent implements OnInit {
  unit: any;
  pageSize = 15;
  currentPage = 1;
  data: Array<any>;
