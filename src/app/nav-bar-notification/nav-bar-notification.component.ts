...
export class NavBarNotificationComponent implements OnInit {
  ...
  opendd: any;
	storedNewNotifications: any;
	storedReadNotifications: any;
  storedawaitingNotifications: any;
...
// 		this.storedNewNotifications = JSON.parse(localStorage.getItem('newNotifications'));
// 		this.storedReadNotifications = JSON.parse(localStorage.getItem('readNotifications'));
// 		this.storedawaitingNotifications = JSON.parse(localStorage.getItem('awaitingNotifications'));
// 		if(this.storedNewNotifications == null){
// 			newNotifications = [
// 				{
...
// 		}
// 		else{
// 			this.newNotifications = this.storedNewNotifications;
// 		}
